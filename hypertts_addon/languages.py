...
class AudioLanguage(enum.Enum):
    ...
    ht_HT = (Language.ht, "Haitian Creole (Haiti)")
    ...
    kok_IN = (Language.kok, "Konkani (India)")
    ...
    mai_IN = (Language.mai, "Maithili (India)")
    mg_MG = (Language.mg, "Malagasy (Madagascar)")
    ...
    nn_NO = (Language.nn, "Norwegian Nynorsk (Norway)")
    ...
    sd_IN = (Language.sd, "Sindhi (India)")

...
GUI_TEXT_SERVICES_CONFIG_TRIAL_DESCRIPTION = """<ul><li>Access to Premium TTS services such as Azure, Google, ElevenLabs, OpenAI, Amazon.</li><li>Highest audio quality possible.</li><li>Immediate access after signing up with your email.</li></ul>"""

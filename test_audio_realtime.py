...
def test_template_regexps(qtbot):
    template_output = """
{{Text}}
<hypertts-template-advanced setting="voice_a" version="1">
...
""".strip()
    ...
    template_output = """
{{Text}}
<hypertts-template setting="voice_c" version="5">{Text} {Extra}</hypertts-template>
"""
    ...
    template_output = """
{{Text}}
<hypertts-template setting="voice_a" version="42">
{Text} {Extra}
</hypertts-template>
"""
    expected_content = """{Text} {Extra}"""
